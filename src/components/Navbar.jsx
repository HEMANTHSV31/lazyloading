...
const Navbar = () => {
  ...
  return (
    <div>
      <div className=" sticky top-0 z-50 flex flex-row justify-between p-5 md:px-32 px-5 bg-black text-white ">
        <div className=" flex items-center">
        <Link to="/" spy={true} smooth={true}>
  <img src={logo} alt="TripPixie Logo" className="cursor-pointer w-50 h-15 bg-transparent" />
</Link>
        </div>
        <nav className="hidden lg:flex flex-row items-center gap-6">
          <Link
            ...
            smooth={true}
            duration={50}
            className=" hover:text-brightColor transition-all cursor-pointer text-decoration-underline"
          >
            Home
          </Link>
          <Link
